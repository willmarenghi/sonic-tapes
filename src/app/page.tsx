      ...
      <AppShell>
        <div className="flex flex-col items-center pt-6 text-center">
          <div className="flex w-fit max-w-full flex-col items-stretch">
            ...
            <Link
              href="/upload"
              className="mt-8 flex min-h-11 w-full items-center justify-center rounded-md bg-accent px-4 text-sm font-medium lowercase text-accent-foreground transition hover:brightness-110 active:scale-95 active:brightness-110"
            >
              + new idea
            </Link>
